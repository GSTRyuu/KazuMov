...
<html>
            ...
            <div class="row">
                <div class="col">
                    <div class="px-0 pt-4 pb-0 mt-3 mb-3">
                        <form id="form" action="ghe" method="get">
                            <ul id="progressbar" class="progressbar-class">
                                <li class="active mo" id="step2"></li>
                            </ul>
                            <br>
                            ...
                            <fieldset>
                                <div id="screen-select-div">
                                    ...
                                    <ul class="time-ul">
                                        <c:forEach items="${requestScope.t}" var="o">
                                            ...
                                            <c:choose>
                                                <c:when test="${sessionScope.jj == o.ten}">
                                                    <c:if test="${o.kiemTra(sessionScope.h, sessionScope.m, o.dia_chi)}">
                                                        <li class="time-li">
                                                            <div class="screens">
                                                                ${o.ten}
                                                            </div>
                                                            <div class="time-btn">
                                                                <input type="button" class="screen-time" value="${o.dia_chi}" onclick="timeFunction('${o.rap_id}')">
                                                            </div>
                                                        </li>   
                                                    </c:if>
                                                </c:when>
                                ...
                                <input type="hidden" name="suat_chieu_id" id="suat_chieu_id" value="">
    ...
    <script>
        ...
        function timeFunction(id) {
            ...
            document.getElementById("suat_chieu_id").value = id;
        }
